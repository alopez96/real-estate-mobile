...
const helpTextHome = 
'This page will help you calculate the following:\n\n'
+'1. Cash needed to purchase the property. This includes down payment and closing costs. On top of the amount given by this app, we recommend also adding expected repair expenses, and $10-15,000 for buffer.\n\n'
+'2. Mortgage payments that you will pay. This includes the Principal and Interest.\n\n'
+'3. Total Monthly expenses that is estimated that you will pay. This is largely affected by the assumed values below.\n\n'
+'4. Monthly cashflow that you can expect from the property. Cash flow is given by taking the income produced by the property (rent) minus the total monthly expenses. The following numbers are asssumed:\n'
+'tax_percent = 0.75%\n'
+'insurance = $2500\n'
+'pmi_percent = 1.0%\n'
+'vacancy_percent = 10%\n'
...
+'capex_monthly = $200\n\n'
+'5. Cash on cash represents your annual return on investment. This is calculated by taking the estimated yearly cash flow and diving it by the initial money invested.'


// text for help screen on Shop page
const helpTextShop = 
'This page will help you run the 1 or 2 percent rule/test.\n\n'
...
+'Overall, the 2% percent rule will not fit every market, but it is a quick and dirty way to scan a property. If something falls within or near 1-2 it can warant further analyzes.'


// text for help screen on AfterRepair page
const helpTextAfterRepair = 
'This page will help you run the 70% rule.\n\n'
