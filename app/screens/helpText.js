...
const helpTextHome = 
'This app will help you analyze Real estate properties. The Rental page will calculate the following:\n\n'
...
+'4. Monthly cashflow that you can expect from the property. Cash flow is given by taking the income produced by the property (rent) minus the expenses on the property. The following numbers are asssumed:\n'
+'tax_percent = 0.75%\n'
+'insurance = $2500\n'
+'pmi_percent = 1.0%\n'
+'vacancy_percent = 10%\n'
...
const helpTextShop = 
'This app will help you analyze Real estate properties. The Percent page will run the 1 or 2 percent rule/test.\n\n'
